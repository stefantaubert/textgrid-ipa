...
def files_convert_text_to_grid(text_folder_in: Path, grid_name_out: Optional[str], tier_out: str, characters_per_second: float, grid_folder_out: Path, overwrite: bool) -> None:
