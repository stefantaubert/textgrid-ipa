...
def app_remove_symbols(directory: Path, tiers: List[str], formatting: StringFormat, symbols: List[Symbol], marks_symbols: List[Symbol], marks: List[str], n_digits: int, output_directory: Optional[Path], overwrite: bool) -> ExecutionResult:
  method = partial(
    remove_symbols,
