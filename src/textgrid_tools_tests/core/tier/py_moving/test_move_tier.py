...
def test_empty__is_not_moved():
  ...
  error, changed_anything = move_tier(grid, tier_name="test", position=1)
...
def test_one_entry__is_not_moved():
  ...
  error, changed_anything = move_tier(grid, tier_name="test", position=0)
...
def test_A_B_move_B_to_0__is_moved():
  ...
  error, changed_anything = move_tier(grid, tier_name="testB", position=0)
...
def test_A_B_move_A_to_1__is_moved():
  ...
  error, changed_anything = move_tier(grid, tier_name="testA", position=1)
